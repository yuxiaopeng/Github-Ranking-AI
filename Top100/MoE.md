...
| ------- | ------------ | ----- | ----- | -------- | ----------- | ----------- | ----------- |
| 1 | [LLaMA-Factory](https://github.com/hiyouga/LLaMA-Factory) | 59829 | 7334 | Python | 681 | Unified Efficient Fine-Tuning of 100+ LLMs & VLMs (ACL 2024) | 2025-10-07T16:18:35Z |
| 2 | [vllm](https://github.com/vllm-project/vllm) | 59664 | 10567 | Python | 1829 | A high-throughput and memory-efficient inference and serving engine for LLMs | 2025-10-09T03:35:50Z |
| 3 | [sglang](https://github.com/sgl-project/sglang) | 18679 | 3091 | Python | 537 | SGLang is a fast serving framework for large language models and vision language models. | 2025-10-09T03:22:36Z |
| 4 | [TensorRT-LLM](https://github.com/NVIDIA/TensorRT-LLM) | 11796 | 1784 | C++ | 719 | TensorRT LLM provides users with an easy-to-use Python API to define Large Language Models (LLMs) and support state-of-the-art optimizations to perform inference efficiently on NVIDIA GPUs. TensorRT LLM also contains components to create Python and C++ runtimes that orchestrate the inference execution in performant way. | 2025-10-09T01:44:58Z |
| 5 | [ms-swift](https://github.com/modelscope/ms-swift) | 10220 | 897 | Python | 574 | Use PEFT or Full-parameter to CPT/SFT/DPO/GRPO 500+ LLMs (Qwen3, Qwen3-MoE, Llama4, GLM4.5, InternLM3, DeepSeek-R1, ...) and 200+ MLLMs (Qwen3-VL, Qwen3-Omni, InternVL3.5, Ovis2.5, Llava, GLM4v, Phi4, ...) (AAAI 2025). | 2025-10-08T13:51:37Z |
| 6 | [xtuner](https://github.com/InternLM/xtuner) | 4919 | 372 | Python | 231 | A Next-Generation Training Engine Built for Ultra-Large MoE Models | 2025-09-30T08:59:48Z |
| 7 | [Bangumi](https://github.com/czy0729/Bangumi) | 4858 | 153 | TypeScript | 25 | :electron: An unofficial https://bgm.tv ui first app client for Android and iOS, built with React Native. 一个无广告、以爱好为驱动、不以盈利为目的、专门做 ACG 的类似豆瓣的追番记录，bgm.tv 第三方客户端。为移动端重新设计，内置大量加强的网页端难以实现的功能，且提供了相当的自定义选项。 目前已适配 iOS / Android。 | 2025-10-06T18:26:15Z |
| 8 | [trace.moe](https://github.com/soruly/trace.moe) | 4799 | 254 | None | 0 | Anime Scene Search by Image | 2025-09-15T13:48:26Z |
...
| 10 | [fastllm](https://github.com/ztxz16/fastllm) | 3982 | 408 | C++ | 291 | fastllm是后端无依赖的高性能大模型推理库。同时支持张量并行推理稠密模型和混合模式推理MOE模型，任意10G以上显卡即可推理满血DeepSeek。双路9004/9005服务器+单显卡部署DeepSeek满血满精度原版模型，单并发20tps；INT4量化模型单并发30tps，多并发可达60+。 | 2025-09-26T11:52:11Z |
| 11 | [flashinfer](https://github.com/flashinfer-ai/flashinfer) | 3864 | 532 | Cuda | 205 | FlashInfer: Kernel Library for LLM Serving | 2025-10-09T02:01:10Z |
| 12 | [MoeKoeMusic](https://github.com/MoeKoeMusic/MoeKoeMusic) | 3841 | 243 | Vue | 15 | 一款开源简洁高颜值的酷狗第三方客户端 An open-source, concise, and aesthetically pleasing third-party client for KuGou that supports  Windows / macOS / Linux / Web :electron: | 2025-09-11T07:49:50Z |
| 13 | [GLM-4.5](https://github.com/zai-org/GLM-4.5) | 2909 | 290 | Python | 21 | GLM-4.5: Agentic, Reasoning, and Coding (ARC) Foundation Models | 2025-09-30T07:56:41Z |
| 14 | [Moe-Counter](https://github.com/journey-ad/Moe-Counter) | 2548 | 263 | JavaScript | 4 | Moe counter badge with multiple themes! - 多种风格可选的萌萌计数器 | 2025-08-12T08:16:18Z |
...
| 17 | [ICEdit](https://github.com/River-Zhang/ICEdit) | 1970 | 110 | Python | 23 | [NeurIPS 2025] Image editing is worth a single LoRA! 0.1% training data for fantastic image editing! Surpasses GPT-4o in ID persistence~ MoE ckpt released! Only 4GB VRAM is enough to run!  | 2025-09-19T15:58:27Z |
| 18 | [MoBA](https://github.com/MoonshotAI/MoBA) | 1921 | 115 | Python | 9 | MoBA: Mixture of Block Attention for Long-Context LLMs | 2025-04-03T07:28:06Z |
...
| 21 | [moemail](https://github.com/beilunyang/moemail) | 1610 | 956 | TypeScript | 30 | 一个基于 NextJS + Cloudflare 技术栈构建的可爱临时邮箱服务🎉 | 2025-09-17T14:42:06Z |
| 22 | [OpenMoE](https://github.com/XueFuzhao/OpenMoE) | 1608 | 82 | Python | 6 | A family of open-sourced Mixture-of-Experts (MoE) Large Language Models | 2024-03-08T15:08:26Z |
| 23 | [paimon-moe](https://github.com/MadeBaruna/paimon-moe) | 1474 | 272 | JavaScript | 298 | Your best Genshin Impact companion! Help you plan what to farm with ascension calculator and database. Also track your progress with todo and wish counter. | 2025-09-30T21:59:02Z |
| 24 | [Cortex](https://github.com/qibin0506/Cortex) | 1468 | 110 | Python | 0 | 个人构建MoE大模型：从预训练到DPO的完整实践 | 2025-10-07T12:41:08Z |
...
| 33 | [MoeMemosAndroid](https://github.com/mudkipme/MoeMemosAndroid) | 858 | 91 | Kotlin | 82 | An app to help you capture thoughts and ideas | 2025-08-26T17:31:03Z |
...
| 40 | [Hunyuan-A13B](https://github.com/Tencent-Hunyuan/Hunyuan-A13B) | 756 | 93 | Python | 13 | Tencent Hunyuan A13B (short as Hunyuan-A13B), an innovative and open-source LLM built on a fine-grained MoE architecture. | 2025-07-08T08:45:27Z |
...
| 67 | [dialogue.moe](https://github.com/windrises/dialogue.moe) | 337 | 10 | Python | 1 | None | 2022-12-14T14:50:38Z |
| 68 | [MoeSR](https://github.com/TeamMoeAI/MoeSR) | 336 | 10 | JavaScript | 7 | An application specialized in image super-resolution for ACGN illustrations and Visual Novel CG. 专注于插画/Galgame CG等ACGN领域的图像超分辨率的应用 | 2025-08-06T14:15:38Z |
...
| 81 | [MoE-Adapters4CL](https://github.com/JiazuoYu/MoE-Adapters4CL) | 249 | 19 | Python | 8 | Code for paper "Boosting Continual Learning of Vision-Language Models via Mixture-of-Experts Adapters" CVPR2024 | 2025-09-18T08:38:29Z |
| 82 | [MiniMind-in-Depth](https://github.com/hans0809/MiniMind-in-Depth) | 249 | 28 | None | 2 | 轻量级大语言模型MiniMind的源码解读，包含tokenizer、RoPE、MoE、KV Cache、pretraining、SFT、LoRA、DPO等完整流程 | 2025-06-16T14:13:15Z |
...
| 86 | [MoE-plus-plus](https://github.com/SkyworkAI/MoE-plus-plus) | 240 | 13 | Python | 1 | [ICLR 2025] MoE++: Accelerating Mixture-of-Experts Methods with Zero-Computation Experts | 2024-10-16T06:21:31Z |
...
| 88 | [gdx-pay](https://github.com/libgdx/gdx-pay) | 233 | 88 | Java | 7 | A libGDX cross-platform API for InApp purchasing. | 2025-10-08T13:58:51Z |
...
| 92 | [Ling](https://github.com/inclusionAI/Ling) | 203 | 17 | Python | 2 | Ling is a MoE LLM provided and open-sourced by InclusionAI.  | 2025-05-14T06:34:57Z |
