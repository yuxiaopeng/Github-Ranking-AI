...
| ------- | ------------ | ----- | ----- | -------- | ----------- | ----------- | ----------- |
| 1 | [LLaMA-Factory](https://github.com/hiyouga/LLaMA-Factory) | 59887 | 7346 | Python | 684 | Unified Efficient Fine-Tuning of 100+ LLMs & VLMs (ACL 2024) | 2025-10-09T14:39:37Z |
| 2 | [vllm](https://github.com/vllm-project/vllm) | 59727 | 10592 | Python | 1811 | A high-throughput and memory-efficient inference and serving engine for LLMs | 2025-10-10T02:53:58Z |
| 3 | [sglang](https://github.com/sgl-project/sglang) | 18712 | 3099 | Python | 547 | SGLang is a fast serving framework for large language models and vision language models. | 2025-10-10T02:58:34Z |
| 4 | [TensorRT-LLM](https://github.com/NVIDIA/TensorRT-LLM) | 11800 | 1788 | C++ | 734 | TensorRT LLM provides users with an easy-to-use Python API to define Large Language Models (LLMs) and support state-of-the-art optimizations to perform inference efficiently on NVIDIA GPUs. TensorRT LLM also contains components to create Python and C++ runtimes that orchestrate the inference execution in performant way. | 2025-10-10T02:20:46Z |
| 5 | [ms-swift](https://github.com/modelscope/ms-swift) | 10246 | 900 | Python | 578 | Use PEFT or Full-parameter to CPT/SFT/DPO/GRPO 500+ LLMs (Qwen3, Qwen3-MoE, Llama4, GLM4.5, InternLM3, DeepSeek-R1, ...) and 200+ MLLMs (Qwen3-VL, Qwen3-Omni, InternVL3.5, Ovis2.5, Llava, GLM4v, Phi4, ...) (AAAI 2025). | 2025-10-09T16:25:19Z |
| 6 | [xtuner](https://github.com/InternLM/xtuner) | 4920 | 374 | Python | 231 | A Next-Generation Training Engine Built for Ultra-Large MoE Models | 2025-10-09T12:23:13Z |
| 7 | [Bangumi](https://github.com/czy0729/Bangumi) | 4871 | 153 | TypeScript | 25 | :electron: An unofficial https://bgm.tv ui first app client for Android and iOS, built with React Native. 一个无广告、以爱好为驱动、不以盈利为目的、专门做 ACG 的类似豆瓣的追番记录，bgm.tv 第三方客户端。为移动端重新设计，内置大量加强的网页端难以实现的功能，且提供了相当的自定义选项。 目前已适配 iOS / Android。 | 2025-10-09T18:35:11Z |
| 8 | [trace.moe](https://github.com/soruly/trace.moe) | 4802 | 254 | None | 0 | Anime Scene Search by Image | 2025-09-15T13:48:26Z |
...
| 10 | [fastllm](https://github.com/ztxz16/fastllm) | 3984 | 408 | C++ | 292 | fastllm是后端无依赖的高性能大模型推理库。同时支持张量并行推理稠密模型和混合模式推理MOE模型，任意10G以上显卡即可推理满血DeepSeek。双路9004/9005服务器+单显卡部署DeepSeek满血满精度原版模型，单并发20tps；INT4量化模型单并发30tps，多并发可达60+。 | 2025-09-26T11:52:11Z |
| 11 | [flashinfer](https://github.com/flashinfer-ai/flashinfer) | 3873 | 534 | Cuda | 208 | FlashInfer: Kernel Library for LLM Serving | 2025-10-09T21:27:55Z |
| 12 | [MoeKoeMusic](https://github.com/MoeKoeMusic/MoeKoeMusic) | 3844 | 243 | Vue | 16 | 一款开源简洁高颜值的酷狗第三方客户端 An open-source, concise, and aesthetically pleasing third-party client for KuGou that supports  Windows / macOS / Linux / Web :electron: | 2025-09-11T07:49:50Z |
| 13 | [GLM-4.5](https://github.com/zai-org/GLM-4.5) | 2922 | 291 | Python | 20 | GLM-4.5: Agentic, Reasoning, and Coding (ARC) Foundation Models | 2025-09-30T07:56:41Z |
...
| 18 | [MoBA](https://github.com/MoonshotAI/MoBA) | 1925 | 115 | Python | 9 | MoBA: Mixture of Block Attention for Long-Context LLMs | 2025-04-03T07:28:06Z |
...
| 21 | [moemail](https://github.com/beilunyang/moemail) | 1611 | 955 | TypeScript | 30 | 一个基于 NextJS + Cloudflare 技术栈构建的可爱临时邮箱服务🎉 | 2025-09-17T14:42:06Z |
...
| 23 | [Cortex](https://github.com/qibin0506/Cortex) | 1480 | 112 | Python | 0 | 个人构建MoE大模型：从预训练到DPO的完整实践 | 2025-10-10T02:54:56Z |
| 24 | [paimon-moe](https://github.com/MadeBaruna/paimon-moe) | 1474 | 272 | JavaScript | 298 | Your best Genshin Impact companion! Help you plan what to farm with ascension calculator and database. Also track your progress with todo and wish counter. | 2025-09-30T21:59:02Z |
...
| 26 | [mixture-of-experts](https://github.com/davidmrau/mixture-of-experts) | 1179 | 110 | Python | 5 | PyTorch Re-Implementation of "The Sparsely-Gated Mixture-of-Experts Layer" by Noam Shazeer et al. https://arxiv.org/abs/1701.06538 | 2024-04-19T08:22:39Z |
| 27 | [moepush](https://github.com/beilunyang/moepush) | 1173 | 308 | TypeScript | 11 | 一个基于 NextJS + Cloudflare 技术栈构建的可爱消息推送服务, 支持多种消息推送渠道✨ | 2025-05-10T11:42:44Z |
