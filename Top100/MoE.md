...
| ------- | ------------ | ----- | ----- | -------- | ----------- | ----------- | ----------- |
| 1 | [LLaMA-Factory](https://github.com/hiyouga/LLaMA-Factory) | 60042 | 7371 | Python | 691 | Unified Efficient Fine-Tuning of 100+ LLMs & VLMs (ACL 2024) | 2025-10-13T03:45:28Z |
| 2 | [vllm](https://github.com/vllm-project/vllm) | 59894 | 10638 | Python | 1808 | A high-throughput and memory-efficient inference and serving engine for LLMs | 2025-10-13T01:25:42Z |
| 3 | [sglang](https://github.com/sgl-project/sglang) | 18771 | 3122 | Python | 539 | SGLang is a fast serving framework for large language models and vision language models. | 2025-10-13T03:32:11Z |
| 4 | [TensorRT-LLM](https://github.com/NVIDIA/TensorRT-LLM) | 11823 | 1792 | C++ | 741 | TensorRT LLM provides users with an easy-to-use Python API to define Large Language Models (LLMs) and support state-of-the-art optimizations to perform inference efficiently on NVIDIA GPUs. TensorRT LLM also contains components to create Python and C++ runtimes that orchestrate the inference execution in performant way. | 2025-10-13T03:38:39Z |
| 5 | [ms-swift](https://github.com/modelscope/ms-swift) | 10294 | 900 | Python | 563 | Use PEFT or Full-parameter to CPT/SFT/DPO/GRPO 500+ LLMs (Qwen3, Qwen3-MoE, Llama4, GLM4.5, InternLM3, DeepSeek-R1, ...) and 200+ MLLMs (Qwen3-VL, Qwen3-Omni, InternVL3.5, Ovis2.5, Llava, GLM4v, Phi4, ...) (AAAI 2025). | 2025-10-11T09:38:35Z |
| 6 | [xtuner](https://github.com/InternLM/xtuner) | 4922 | 374 | Python | 232 | A Next-Generation Training Engine Built for Ultra-Large MoE Models | 2025-10-13T02:37:58Z |
| 7 | [Bangumi](https://github.com/czy0729/Bangumi) | 4882 | 153 | TypeScript | 24 | :electron: An unofficial https://bgm.tv ui first app client for Android and iOS, built with React Native. 一个无广告、以爱好为驱动、不以盈利为目的、专门做 ACG 的类似豆瓣的追番记录，bgm.tv 第三方客户端。为移动端重新设计，内置大量加强的网页端难以实现的功能，且提供了相当的自定义选项。 目前已适配 iOS / Android。 | 2025-10-12T15:29:57Z |
...
| 10 | [fastllm](https://github.com/ztxz16/fastllm) | 3989 | 410 | C++ | 291 | fastllm是后端无依赖的高性能大模型推理库。同时支持张量并行推理稠密模型和混合模式推理MOE模型，任意10G以上显卡即可推理满血DeepSeek。双路9004/9005服务器+单显卡部署DeepSeek满血满精度原版模型，单并发20tps；INT4量化模型单并发30tps，多并发可达60+。 | 2025-09-26T11:52:11Z |
| 11 | [flashinfer](https://github.com/flashinfer-ai/flashinfer) | 3890 | 539 | Cuda | 206 | FlashInfer: Kernel Library for LLM Serving | 2025-10-12T13:37:35Z |
| 12 | [MoeKoeMusic](https://github.com/MoeKoeMusic/MoeKoeMusic) | 3860 | 246 | Vue | 15 | 一款开源简洁高颜值的酷狗第三方客户端 An open-source, concise, and aesthetically pleasing third-party client for KuGou that supports  Windows / macOS / Linux / Web :electron: | 2025-09-11T07:49:50Z |
| 13 | [GLM-4.5](https://github.com/zai-org/GLM-4.5) | 2954 | 299 | Python | 16 | GLM-4.5: Agentic, Reasoning, and Coding (ARC) Foundation Models | 2025-10-11T03:42:50Z |
...
| 17 | [ICEdit](https://github.com/River-Zhang/ICEdit) | 1974 | 110 | Python | 23 | [NeurIPS 2025] Image editing is worth a single LoRA! 0.1% training data for fantastic image editing! Surpasses GPT-4o in ID persistence~ MoE ckpt released! Only 4GB VRAM is enough to run!  | 2025-10-13T01:59:51Z |
| 18 | [MoBA](https://github.com/MoonshotAI/MoBA) | 1928 | 116 | Python | 9 | MoBA: Mixture of Block Attention for Long-Context LLMs | 2025-04-03T07:28:06Z |
...
| 21 | [moemail](https://github.com/beilunyang/moemail) | 1618 | 959 | TypeScript | 31 | 一个基于 NextJS + Cloudflare 技术栈构建的可爱临时邮箱服务🎉 | 2025-10-12T17:16:26Z |
...
| 23 | [Cortex](https://github.com/qibin0506/Cortex) | 1510 | 116 | Python | 0 | 个人构建MoE大模型：从预训练到DPO的完整实践 | 2025-10-11T11:40:11Z |
...
| 26 | [mixture-of-experts](https://github.com/davidmrau/mixture-of-experts) | 1183 | 110 | Python | 5 | PyTorch Re-Implementation of "The Sparsely-Gated Mixture-of-Experts Layer" by Noam Shazeer et al. https://arxiv.org/abs/1701.06538 | 2024-04-19T08:22:39Z |
